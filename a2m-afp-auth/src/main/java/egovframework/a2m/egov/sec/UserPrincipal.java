...
public class UserPrincipal implements OAuth2User, UserDetails {
    ...
    public UserPrincipal(String id, String userId, String userUid, String email, String password, String authProvider, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.userId = userId;
    ...
    public static UserPrincipal create(UserResponse user) {
        List<GrantedAuthority> authorities = Collections.
                singletonList(new SimpleGrantedAuthority(RoleConstants.DEFAULT_ROLE_3RD_PARTY.getValue()));
